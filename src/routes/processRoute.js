...
routes.put('/user/process/:id', (req, res) => new ProcessController().updateProcess(req, res));        
routes.delete('/user/process/:id', (req, res) => new ProcessController().deleteProcess(req, res));    

routes.get('/user/process/user/:id', (req, res) => new ProcessController().getUserProcess(req, res));   
