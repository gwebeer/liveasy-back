...
routes.get('/user/list/cost/item/:id', (req, res) => new CostItemListController().getCostItemList(req, res));        
routes.put('/user/list/cost/item/:id', (req, res) => new CostItemListController().updateCostItemList(req, res));     
