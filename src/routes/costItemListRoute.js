...
routes.get('/user/list/cost/item', (req, res) => new CostItemListController().getCostItemList(req, res));        
routes.put('/user/list/cost/item', (req, res) => new CostItemListController().updateCostItemList(req, res));     
routes.delete('/user/list/cost/item', (req, res) => new CostItemListController().deleteCostItemList(req, res));  
