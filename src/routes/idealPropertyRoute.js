...
routes.get('/user/property', (req, res) => new IdealPropertyController().getIdealProperty(req, res));        
routes.put('/user/property', (req, res) => new IdealPropertyController().updateIdealProperty(req, res));     
routes.delete('/user/property', (req, res) => new IdealPropertyController().deleteIdealProperty(req, res));  
