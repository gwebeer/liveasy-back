...
routes.get('/user/property/:id', (req, res) => new IdealPropertyController().getIdealProperty(req, res));        
routes.put('/user/property/:id', (req, res) => new IdealPropertyController().updateIdealProperty(req, res));     
