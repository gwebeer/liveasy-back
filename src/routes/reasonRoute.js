...
routes.get('/user/property/reason', (req, res) => new ReasonController().getReason(req, res));        
routes.put('/user/property/reason', (req, res) => new ReasonController().updateReason(req, res));     
routes.delete('/user/property/reason', (req, res) => new ReasonController().deleteReason(req, res));  
